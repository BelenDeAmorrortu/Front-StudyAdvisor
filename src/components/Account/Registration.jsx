...
import style from '../../StyleSheets/Account/Registration.module.scss'
  	...
  	return (
		...
		<div className={style.form_container}>
			...
			<form className={`${style.form} ${style[currentTheme]}`}>
				...
				<p className={style.logIn}>You already have an account? <span onClick={()=>navigate('/signIn')}>Log In</span></p>
			</form>
